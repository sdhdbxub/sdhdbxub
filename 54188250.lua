...
local OrionLib = {
	...
	Themes = {
		Default = {
			Main = Color3.fromRGB(242, 243, 243),
			Second = Color3.fromRGB(242, 243, 243),
			Stroke = Color3.fromRGB(242, 243, 243),
			Divider = Color3.fromRGB(242, 243, 243),
			Text = Color3.fromRGB(4, 175, 236),
			TextDark = Color3.fromRGB(152, 194, 219)
		}
	},
